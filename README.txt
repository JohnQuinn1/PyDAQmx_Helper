...
The classes provide interfaces for the Analogue-to-Digital (ADC) Convertors, Digital-to-Analogue (DAC) Convertors, DigitalIO and Counters.  They were developed for Physics undergraduate laboratories at University College Dublin based on in-house C++ classes. These python classes were originally developed by Marco Forte as part of a summer internship.
